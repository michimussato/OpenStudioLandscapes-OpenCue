<!-- TOC -->
* [OpenStudioLandscapes-OpenCue](#openstudiolandscapes-opencue)
<!-- TOC -->
...
Instead of the [`definitions.py`](src/OpenStudioLandscapes/OpenCue/definitions.py), 
the accompanying [`workspace.yaml`](workspace.yaml) loads 
the [`_definitions_with_upstream_specs.py`](src/OpenStudioLandscapes/OpenCue/_definitions_with_upstream_specs.py) 
which also contains 
