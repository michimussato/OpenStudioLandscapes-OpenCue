...
FEATURE_CONFIGS = {
    OpenStudioLandscapesConfig.DEFAULT: {
        ...
        "HOSTNAME": "opencue",  # This is assumed for now (for teleport service. is there a web service at all?f)
        "OPENCUE_PLACEHOLDER_PORT_HOST": "1234",
        ...
        "TELEPORT_ENTRY_POINT_PORT": "{{OPENCUE_PLACEHOLDER_PORT_HOST}}",  # Either a hardcoded str or a ref to a Variable (with double {{ }}!)
        # cuebot
